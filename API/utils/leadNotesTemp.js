module.exports = ({  first_name, last_name, comments }) => {
    return `
          ...
          <tbody>
            <tr>
              <td style="padding: 0" align="center">
                ...
                <tr>
                  <td>
                    <p style="font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;margin-top:0px;margin-bottom: 16px;color: #000;">Lead Notes Added or Documents Added</p>
                 ...
                 <tr>
                  <td style="padding-bottom:30px;">
                    <table style="border:1px solid #a9a9a9;border-spacing: 0px;width:50%;">
                      ...
                      <tr>
                        <td style="font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;color: #000;padding: 10px;border-right:1px solid #a9a9a9;">Lead Owner</td>
    ...
    <p style="font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;margin-top:0px;margin-bottom: 16px;color: #000;"><span>${comments}</span></p>
    
    <p style="font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;margin-top:0px;margin-bottom: 16px;color: #000;"><span>https://crm.zoho.com/</span></p>
